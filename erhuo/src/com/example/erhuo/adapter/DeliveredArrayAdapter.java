...
public class DeliveredArrayAdapter extends BaseAdapter
{
    // 需要包装的JSONArray
    private JSONArray deliveredArray;
    private Context ctx;
    public DeliveredArrayAdapter(JSONArray deliveredArray
            ,Context ctx)
    {
    ...
    public Object getItem(int position)
    {
        ...
        return deliveredArray.optJSONObject(position);
    }
